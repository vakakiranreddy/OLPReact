...
const Departments = React.lazy(() => import('../pages/common/Departments'))
const DepartmentLicenses = React.lazy(() => import('../pages/common/DepartmentLicenses'))
const ApplyLicense = React.lazy(() => import('../pages/applicant/ApplyLicense'))
const MyApplications = React.lazy(() => import('../pages/applicant/MyApplications'))
const MyLicenseCertifications = React.lazy(() => import('../pages/applicant/MyLicenseCertifications'))
const ApplicationProcess = React.lazy(() => import('../pages/applicant/ApplicationProcess'))

const ApplicationDetails = React.lazy(() => import('../pages/common/ApplicationDetails'))
const DocumentUpload = React.lazy(() => import('../pages/applicant/DocumentUpload'))
const PaymentPage = React.lazy(() => import('../pages/applicant/PaymentPage'))
const ReviewerDashboard = React.lazy(() => import('../pages/reviewer/ReviewerDashboard'))
const DepartmentHeadDashboard = React.lazy(() => import('../pages/department-head/DepartmentHeadDashboard'))
const AdminUserManagement = React.lazy(() => import('../pages/admin/AdminUserManagement'))
const AdminRequiredDocuments = React.lazy(() => import('../pages/admin/AdminRequiredDocuments'))
